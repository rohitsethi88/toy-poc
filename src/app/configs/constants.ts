...
export const ERRORS = {
  ...
  invalidInitialCommand: `Invalid PLACE command format. The valid PLACE command should be 'PLACE X,Y,F' for ex: 'PLACE 0,0,EAST'.`,
  notInitialized: `The robot is not placed on the table yet. Place it first with 'PLACE X,Y,F' ex: 'PLACE 0,0,EAST'`,
